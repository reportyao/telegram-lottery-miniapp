...
Deno.serve(async (req) => {
    ...
    bucketConfig.file_size_limit = 3145728;
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for user-posts" ON storage.objects FOR SELECT USING (bucket_id = 'user-posts');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for user-posts" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'user-posts');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for user-posts" ON storage.objects FOR UPDATE USING (bucket_id = 'user-posts');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for user-posts" ON storage.objects FOR DELETE USING (bucket_id = 'user-posts');`
    ];
